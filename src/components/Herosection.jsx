        ...
        <div className="header flex flex-col gap-y-5 md:flex-row md:px-[20px] sm:px-[90px] w-full">
          ...
          <div className="flex lg:flex-1  flex-col sm:flex-row gap-y-5 lg:w-full  items-center md:w-[70%]  w-full justify-between ">
            ...
            <div className=" p-0 m-0 w-[240px] flex flex-col sm:justify-start  sm:items-start items-center ">
              ...
              <div className="flex items-center gap-3  text-[16px]  min-w-[230px] sm:w-[300px] overflow-x-auto" >
                I am
                <TypeAnimation
                  sequence={[
                    " a Software Engineer",
          ...
          <div className="items-center flex relative flex-col justify-between sm:flex-row gap-y-5  md:justify-end  z-10 flex  gap-x-10  w-full lg:flex-1 md:w-[30%]">
            ...
            <div className="flex gap-5 sm:w-[235px]">
              <div>
