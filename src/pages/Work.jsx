    ...
    <Navbar>
      ...
      py-2 sm:px-5 px-8 md:px-10 overflow-hidden z-20 relative slide-up-animation slide-up-animation">
        {data.map((item) => {
          return (
            <>
              <div className=" hidden lg:block w-full lg:max-w-[30%] md:w-[40%] xsm:w-[280px]  card rounded-lg shadow   z-20 bg-[#000000] sm:bg-[#101a24]" >
                ...
                <div className="px-5 py-2 w-full">
                  ...
                  <div className="flex items-center justify-between">
                    <a href="#" className="text-white bg-blue-400 hover:bg-blue-600 focus:outline-none focus:ring-blue-300 font-medium rounded-[6px] text-sm px-5 py-2 text-center ">Details</a>
              ...
              <div className=" lg:hidden w-full  lg:max-w-[30%] md:w-[40%] xsm:w-[280px]  card rounded-lg shadow   z-20 bg-[#000000] sm:bg-[#101a24] " data-aos={item.id % 2 === 0 ? "fade-right" : "fade-left"}>
